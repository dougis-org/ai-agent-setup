...
*   [**`codebase-health`**](file:///c:/dev/ai-agent-setup/catalog/skills/codebase-health/SKILL.md)
...
*   [**`test-generator`**](file:///c:/dev/ai-agent-setup/catalog/skills/test-generator/SKILL.md)
...
*   [**`readme-builder`**](file:///c:/dev/ai-agent-setup/catalog/skills/readme-builder/SKILL.md)
...
*   [**`pr-reviewer`**](file:///c:/dev/ai-agent-setup/catalog/skills/pr-reviewer/SKILL.md)
...
You can load these skills into your target client environments (such as Antigravity IDE or Claude Code) using our cross-platform installation scripts. For detailed installation instructions, please refer back to the [**README.md**](file:///c:/dev/ai-agent-setup/README.md).
